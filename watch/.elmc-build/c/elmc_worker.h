...
#define ELMC_WORKER_SUB_TAG_SLOTS 4
#define ELMC_WORKER_SLOT_APPMESSAGE 0
#define ELMC_WORKER_SLOT_HOUR_CHANGE 1
#define ELMC_WORKER_SLOT_MINUTE_CHANGE 2
#define ELMC_WORKER_SLOT_SECOND_CHANGE 3
