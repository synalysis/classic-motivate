...
#define ELMC_PEBBLE_FEATURE_TOUCH_TAP_EVENTS 0
#define ELMC_PEBBLE_FEATURE_TOUCH_PAN_HORIZONTAL_EVENTS 0
#define ELMC_PEBBLE_FEATURE_TOUCH_PAN_VERTICAL_EVENTS 0
#define ELMC_PEBBLE_FEATURE_TOUCH_SWIPE_EVENTS 0
...
#define ELMC_PEBBLE_FEATURE_BACKLIGHT_EVENTS 0
#define ELMC_PEBBLE_FEATURE_SCREEN_CHANGE_EVENTS 0
#define ELMC_PEBBLE_FEATURE_SPEAKER_FINISHED_EVENTS 0
#define ELMC_PEBBLE_FEATURE_INBOX_EVENTS 1
#define ELMC_PEBBLE_FEATURE_CMD_TIMER_AFTER_MS 0
#define ELMC_PEBBLE_FEATURE_CMD_STORAGE_WRITE_INT 1
#define ELMC_PEBBLE_FEATURE_CMD_STORAGE_READ_INT 1
...
#define ELMC_PEBBLE_FEATURE_CMD_STORAGE_READ_MAX_SIZE 0
...
#define ELMC_PEBBLE_FEATURE_CMD_GET_WATCH_COLOR 1
...
#define ELMC_PEBBLE_FEATURE_CMD_HEALTH_HRV_PPI_MS 0
#define ELMC_PEBBLE_FEATURE_CMD_HEALTH_SET_HRV_SAMPLE_PERIOD 0
#define ELMC_PEBBLE_FEATURE_CMD_HEALTH_SET_HEART_RATE_SAMPLE_PERIOD 0
...
#define ELMC_PEBBLE_FEATURE_CMD_ALARM_NEXT 0
#define ELMC_PEBBLE_FEATURE_CMD_TOUCH_SUPPORTED 0
#define ELMC_PEBBLE_FEATURE_CMD_TOUCH_ENABLE_NAVIGATION 0
...
typedef enum {
  ...
  ELMC_PEBBLE_MSG_SECONDCHANGED = 2,
  ELMC_PEBBLE_MSG_MINUTECHANGED = 3,
  ELMC_PEBBLE_MSG_HOURCHANGED = 4,
  ELMC_PEBBLE_MSG_FROMPHONE = 5,
...
#define ELMC_PEBBLE_HAS_MSG_SECONDCHANGED 1
...
typedef enum {
  ...
  ELMC_PEBBLE_CMD_HEALTH_HRV_PPI_MS = 52,
  ELMC_PEBBLE_CMD_HEALTH_SET_HRV_SAMPLE_PERIOD = 53,
  ELMC_PEBBLE_CMD_HEALTH_SET_HEART_RATE_SAMPLE_PERIOD = 54,
  ELMC_PEBBLE_CMD_ALARM_NEXT = 55,
  ELMC_PEBBLE_CMD_TOUCH_SUPPORTED = 56,
  ELMC_PEBBLE_CMD_TOUCH_ENABLE_NAVIGATION = 57
...
#define ELMC_PEBBLE_MSG_PHONE_TO_WATCH_TARGET 5
